...
public class PersonnelController {
	...
	public ResponseEntity<String> createNewPersonnel(final String nom, final String prenom,
			@DateTimeFormat(iso = DateTimeFormat.ISO.DATE) final LocalDate dateNaissance, final String adresse,
			final String matricule, final String photo, final String cin, final String sexe, final String rib,
			final String poste, @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) final LocalDate dateEmbauche,
			final String phone, final String categorie, final String ville, final String codePostal, final String email)
			throws ResourceNotFoundException {

		personnelService.createNewPersonnel(nom, prenom, dateNaissance, adresse, matricule, photo, cin, sexe, rib,
				poste, dateEmbauche, phone, categorie, ville, codePostal, email);
	...
	public ResponseEntity<String> updatePersonnel(
			...
			@DateTimeFormat(iso = DateTimeFormat.ISO.DATE) final LocalDate dateNaissance, final String matricule,
			final String adresse, final String photo, final String cin, final String sexe, final String rib,
			final String poste, @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) final LocalDate dateEmbauche,
			final int echelon, final String phone, final String categorie, final String ville, final String codePostal,
			final String email) throws ResourceNotFoundException {
		personnelService.updatePersonnel(idPersonnel, nom, prenom, dateNaissance, adresse, matricule, photo, cin, sexe,
				rib, poste, dateEmbauche, echelon, phone, categorie, ville, codePostal, email);
