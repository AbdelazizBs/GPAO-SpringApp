...
public class ClientServiceImpl implements ClientService {
    ...
    public void updateClient(String idClient, String refClientIris,
        ...
        verifyFields(refClientIris, raisonSociale, adresse, codePostal, ville, pays, region, email);
    ...
    private static void verifyFields(String refClientIris, String raisonSociale, String adresse, String codePostal, String ville, String pays, String region, String email) {
        if (!validate(email)) {
            throw new IllegalArgumentException(" email " + email + "  n'est pas valide !!");
        }
