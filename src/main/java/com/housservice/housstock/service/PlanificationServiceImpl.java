...
LigneCommandeClientRepository ligneCommandeClientRepository;
    ...
    @Override
    public PlanificationOfDTO buildPersonnelDtoFromPlanificationOf(PlanificationOf planificationOf) {
    ...
    private PlanificationOf buildPersonnelFromPlanificationOfDTO(PlanificationOfDTO planificationOfDTO) throws ResourceNotFoundException {
